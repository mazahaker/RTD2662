...
void CPDrawMainMenu(BYTE ucDrawID)
{
    switch(ucDrawID)
    {
        ...
        case _DRAW_BEFORE_RETURN_PARENTMENU://���ص���һ���˵�֮ǰ...
             COsdFxDisableOsd();
        	 break;
        case _DRAW_BEFORE_ENTER_SUBMENU:    //�����Ӳ˵�֮ǰ...
        case _DRAW_FROM_SUBMENU_RETURN:     //���Ӳ˵�����
             break;
    }
}
