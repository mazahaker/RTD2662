    ...
    {         
        ...
        case _NOSIGNAL_STATE:
            ...
            {    
    			...
    			{
    				CTimerReactiveTimerEvent(SEC(0.5), CModeNoSignalEvent); // время появления сообщения нет сигнала
    				CTimerReactiveTimerEvent(SEC(1), CModePowerSavingEvent); // время задержки выключения подсветки
    				break;
    			}		
